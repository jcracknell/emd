...
namespace JFM.DOM {
	public class EntityNode : Node {
		...
		public static bool IsEntityName(string name) {
			return NamedHtmlEntityDefinitions.ContainsKey(name);
		}

		public static int GetNamedEntityValue(string name) {
			return NamedHtmlEntityDefinitions[name];
		}

		private static readonly IDictionary<string, int> NamedHtmlEntityDefinitions = new Dictionary<string, int>() {
			#region BleaaaAAarrrgh
			{ "Tab", 9 },
			{ "NewLine", 10 },
			{ "excl", 33 },
			{ "quot", 34 },
