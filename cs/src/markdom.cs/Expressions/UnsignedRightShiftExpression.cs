...
namespace markdom.cs.Expressions {
	public class UnsignedRightShiftExpression : BinaryExpression {
		public UnsignedRightShiftExpression(IExpression left, IExpression right, SourceRange sourceRange)
